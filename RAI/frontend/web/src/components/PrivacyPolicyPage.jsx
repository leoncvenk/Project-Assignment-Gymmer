...
export default function PrivacyPolicyPage() {
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center bg-[radial-gradient(circle_at_center,_#3a3a3a_0%,_#111111_70%,_#050505_100%)] p-6 overflow-hidden">
        ...
        <div className="bg-[#1a1a1a]/80 backdrop-blur-md border border-white/10 p-8 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex flex-col h-full overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6 pb-6 border-b border-white/10 shrink-0">
            <div className="flex items-center gap-3">
              <h2 className="text-2xl md:text-3xl text-white font-bold tracking-wide">Privacy Policy</h2>
            </div>
            <Link 
              to="/profile" 
          ...
          <div className="overflow-y-auto pr-4 space-y-6 text-gray-400 text-sm leading-relaxed custom-scrollbar">
            ...
            <h3 className="text-lg text-white font-semibold mt-4">1. Information We Collect</h3>
            ...
            <h3 className="text-lg text-white font-semibold mt-4">2. How We Use Your Information</h3>
            ...
            <h3 className="text-lg text-white font-semibold mt-4">3. Will Your Information Be Shared?</h3>
            <p>
            ...
            <h3 className="text-lg text-white font-semibold mt-4">4. How Long Do We Keep Your Information?</h3>
            <p>
              We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy notice, unless a longer retention period is required or permitted by law. When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize such information.
            </p>

            <h3 className="text-lg text-white font-semibold mt-4">5. How Do We Keep Your Information Safe?</h3>
            <p>
              We have implemented appropriate technical and organizational security measures designed to protect the security of any personal information we process. However, despite our safeguards and efforts to secure your information, no electronic transmission over the Internet or information storage technology can be guaranteed to be 100% secure.
            </p>

            <h3 className="text-lg text-white font-semibold mt-4">6. Your Privacy Rights</h3>
            <p>
            ...
            <h3 className="text-lg text-white font-semibold mt-4">7. Contact Us</h3>
            <p>
      ...
      {/* Global CSS for the custom scrollbar to match the dark theme */}
