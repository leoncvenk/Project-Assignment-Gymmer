    ...
    <div className="relative min-h-screen w-full flex flex-col bg-[var(--background)] overflow-x-hidden text-[var(--text-primary)]">
      ...
      <div className="flex-1 flex flex-col justify-center w-full max-w-[1500px] mx-auto px-8 lg:px-16 pt-32 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-32 w-full mb-20">
          ...
          >
            <h1 
              className="text-[var(--text-primary)] text-[40px] sm:text-[50px] lg:text-[60px] leading-none tracking-wider mb-6 uppercase"
              style={{ fontFamily: "'Anton', sans-serif" }}
            >
              BROWSE RECIPES
            </h1>
            <p 
              className="text-[var(--muted)] text-lg sm:text-xl leading-relaxed max-w-md"
        ...
        >
          <h2 
            className="text-[var(--text-primary)] text-[40px] sm:text-[50px] lg:text-[60px] leading-none tracking-wider mb-8 uppercase text-center"
            style={{ fontFamily: "'Anton', sans-serif" }}
          >
            GET IN SHAPE TODAY
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-[var(--surface-dark)] border border-[var(--border)] flex items-center gap-3 px-6 py-3 rounded-xl hover:bg-[var(--surface)] transition-colors cursor-pointer"
            >
