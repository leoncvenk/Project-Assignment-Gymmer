...
import { X, Calendar, Dumbbell, Clock, Flame, Footprints, Route } from 'lucide-react';
          ...
          >
            {activity.image && (
              <div className="w-full h-48 bg-gray-100 relative">
                ...
                <button
                  onClick={onClose}
                  className="absolute top-4 right-4 bg-black/50 text-white rounded-full p-1.5 hover:bg-black/80 transition-colors cursor-pointer"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
            ...
            <div className="p-6 overflow-y-auto">
              ...
              <h2 className="text-2xl font-bold text-[#2b2b2b] mb-1 flex items-center gap-2">
                {activity.title}
                {activity.feeling && <span>{activity.feeling}</span>}
              </h2>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                ...
                <div className="bg-gray-50 p-3 rounded-lg border border-gray-100 flex flex-col items-center justify-center">
                  <Footprints className="w-5 h-5 text-[#00a97f] mb-1" />
                ...
                <div className="bg-gray-50 p-3 rounded-lg border border-gray-100 flex flex-col items-center justify-center">
                  <Route className="w-5 h-5 text-[#00a97f] mb-1" />
